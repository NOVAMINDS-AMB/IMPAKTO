...
export function ScreenLogin2FA({ onNext, onBack, username }: ScreenLogin2FAProps) {
  ...
  const handleVerify = () => {
    // Simulate user selection based on code
    // User1 (no loan): code "123456"
    // User2 (has loan): code "654321"
    if (code === '654321') {
      onNext('user2');
    } else {
      onNext('user1');
      ...
      <div className="flex-1">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
          <p className="text-sm text-blue-800">
            <span className="font-semibold">Demo Codes:</span><br/>
            Enter <span className="font-mono font-semibold">123456</span> for User 1 (no active loan)<br/>
            Enter <span className="font-mono font-semibold">654321</span> for User 2 (active loan)
          </p>
        </div>
