...
export function ScreenDigitizedEntry({ onNext }) {
    ...
    return (_jsxs(MobileScreen, { backgroundColor: "bg-gray-50", children: [_jsxs("div", { className: "flex-1 overflow-y-auto pb-6", children: [_jsxs("div", { className: "bg-emerald-50 border border-emerald-200 rounded-xl p-4 mb-6 flex items-center gap-3", children: [_jsx(CheckCircle2, { className: "w-8 h-8 text-emerald-600 flex-shrink-0" }), _jsxs("div", { children: [_jsx("h3", { className: "font-semibold text-emerald-900", children: "AI Extraction Complete!" }), _jsx("p", { className: "text-sm text-emerald-700", children: "Please review the details below" })] })] }), _jsx("h2", { className: "text-2xl mb-1 text-gray-900", children: "Review Entry" }), _jsx("p", { className: "text-gray-600 mb-6", children: "Confirm Impakto AI read your handwriting correctly." }), _jsxs("div", { className: "bg-white rounded-xl p-5 border border-gray-200 space-y-4 shadow-sm", children: [_jsxs("div", { className: "flex items-center gap-3 pb-4 border-b border-gray-100", children: [_jsx("div", { className: `rounded-lg p-3 ${draftData.transaction_type === 'INCOME' ? 'bg-emerald-100' : 'bg-red-100'}`, children: draftData.transaction_type === 'INCOME' ? (_jsx(TrendingUp, { className: "w-6 h-6 text-emerald-600" })) : (_jsx(TrendingDown, { className: "w-6 h-6 text-red-600" })) }), _jsxs("div", { className: "flex-1 overflow-y-auto", children: [_jsx("p", { className: "text-sm text-gray-600", children: "Transaction Type" }), _jsx("p", { className: "font-semibold text-gray-900", children: draftData.transaction_type === 'INCOME' ? 'Income / Sale' : 'Expense' })] })] }), _jsxs("div", { className: "flex items-center gap-3 pb-4 border-b border-gray-100", children: [_jsx("div", { className: "bg-blue-100 rounded-lg p-3", children: _jsx(Calendar, { className: "w-6 h-6 text-blue-600" }) }), _jsxs("div", { className: "flex-1 overflow-y-auto", children: [_jsx("p", { className: "text-sm text-gray-600", children: "Date" }), _jsx("p", { className: "font-semibold text-gray-900", children: formatDate(draftData.transaction_date) })] })] }), _jsxs("div", { className: "flex items-center gap-3 pb-4 border-b border-gray-100", children: [_jsx("div", { className: "bg-amber-100 rounded-lg p-3", children: _jsx(DollarSign, { className: "w-6 h-6 text-amber-600" }) }), _jsxs("div", { className: "flex-1 overflow-y-auto", children: [_jsx("p", { className: "text-sm text-gray-600", children: "Amount" }), _jsx("p", { className: "font-semibold text-gray-900 text-xl", children: formatCurrency(draftData.amount) })] })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "bg-purple-100 rounded-lg p-3", children: _jsx(FileText, { className: "w-6 h-6 text-purple-600" }) }), _jsxs("div", { className: "flex-1 overflow-y-auto", children: [_jsx("p", { className: "text-sm text-gray-600", children: "Description" }), _jsx("p", { className: "font-semibold text-gray-900", children: draftData.description || draftData.category || 'N/A' }), _jsx("p", { className: "text-xs text-gray-500 uppercase tracking-wider mt-1", children: draftData.category })] })] })] }), _jsx("div", { className: "bg-blue-50 border border-blue-200 rounded-xl p-4 mt-6", children: _jsx("p", { className: "text-sm text-blue-800", children: "Saving this entry will update your ledger and immediately recalculate your Trust Score." }) })] }), _jsxs("div", { className: "mt-auto pt-4 flex gap-3", children: [_jsx("button", { onClick: () => window.history.back(), disabled: isSaving, className: "px-6 py-4 bg-gray-200 text-gray-700 rounded-xl font-semibold disabled:opacity-50", children: "Retake" }), _jsx("div", { className: "flex-1 overflow-y-auto", children: _jsx(PrimaryButton, { onClick: handleConfirmAndSave, disabled: isSaving, children: isSaving ? (_jsxs(_Fragment, { children: [_jsx(Loader2, { className: "w-5 h-5 animate-spin mr-2 inline" }), " Saving..."] })) : ('Confirm & Save') }) })] })] }));
}
